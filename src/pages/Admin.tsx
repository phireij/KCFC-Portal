    ...
    <div className="kcfc-page space-y-5 pb-4">
      <section className="overflow-hidden rounded-[26px] border border-blue-100 bg-gradient-to-br from-[#123B66] via-[#174E83] to-[#2563EB] p-5 text-white shadow-[0_18px_45px_rgba(18,59,102,0.18)] sm:p-7">
        <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            ...
            <p className="mt-2 max-w-xl text-[14px] leading-6 text-blue-50/90">Approvals, roles, member administration, broadcasts, inquiries and system settings remain available while we progressively reorganize the leadership workspace around clear operational queues.</p>
          </div>
      ...
      <section className="kcfc-surface overflow-hidden">
        <div className="border-b border-slate-100 px-4 py-4 sm:px-5 dark:border-white/10">
          <h2 className="text-[18px] font-extrabold tracking-tight text-[#172033] dark:text-white">Administration workspace</h2>
          <p className="mt-1 text-[12px] leading-5 text-slate-500 dark:text-slate-400">The proven administration engine is preserved below while individual leadership workflows are migrated into the new KCFC design system.</p>
        </div>
